...
public class MxLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"BlockComment", "LineComment", "Inc", "Dec", "Add", "Sub", "Mul", "Div", 
			"Mod", "LAnd", "LOr", "LNot", "Nequal", "Equal", "LShift", "RShift", 
			...
			"Identifier", "Integer", "EscapeChar", "StringChar", "WhiteSpace", "NewLine"
		};
	}
